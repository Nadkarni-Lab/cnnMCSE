...
"""
import argparse
from cnnMCSE.predict import experiment_loop, batch_loop
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dim", required=False, type=int, default=None, 
                        help="Input dimension.")
    
    parser.add_argument("--hidden_size", required=False, type=int, default=None, 
                        help="Size of the hidden layer.")
    
    parser.add_argument("--out_prediction_path", required=True, type=str, default=None, 
                        help="Path to save predictions.")
    
    parser.add_argument("--start_seed", required=False, type=str, default=None, 
                        help="Seed.")
...
def initial_command():
    return f"""python n-features.py --datasets synthetic,6000,2,784,10 \
    --models A3,FCN \
    ...
    --out_data_path /sc/arion/projects/EHR_ML/gulamf01/cnnMCSE/output/figure6/50_fcn_data.tsv \
    --out_metadata_path /sc/arion/projects/EHR_ML/gulamf01/cnnMCSE/output/figure6/50_fcn_metadata.tsv """