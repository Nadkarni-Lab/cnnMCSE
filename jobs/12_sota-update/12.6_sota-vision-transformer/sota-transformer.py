...
class Classifier(LightningModule):
    def __init__(self, batch_size:int=4, learning_rate:float=0.01, num_class=2, home_dir:str=None, zoo_model="radimagenet"):
        ...
        self.pretrained_model = vit_b_16(weights=weights)
        self.feature_extractor = nn.Sequential(*list(self.pretrained_model.children())[:-1])
        self.backbone = self.feature_extractor[1]
    ...
    for current_dataset in dataset_list:
        ...
        for trainset in training_set:
            ...
            for sample_size in sample_sizes:
                ...
                model = Classifier(num_class=num_classes, home_dir=initial_weights_dir)
                ...
                early_stop_callback = EarlyStopping(
                    monitor="epoch_val_auroc", min_delta=0.01, patience=3, 
                ...
                trainer = Trainer(
                    ...
                    devices= num_gpus if torch.cuda.is_available() else "auto",  # limiting got iPython runs
                    num_nodes=num_nodes,
