...
if __name__ == "__main__":
    ...
    parser.add_argument("--current_bootstrap", required=True, type=int, 
                        help="Run a single bootstrap at a time.")
    ...
    print('Out datapath ', config_kwargs.out_data_path)
    print('Out metadata path ', config_kwargs.out_metadata_path)
